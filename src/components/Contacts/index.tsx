          ...
          <ContactsCards>
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  fique a vontade para inicar uma conversa comigo, ficarei feliz em responder
                </Text>
                <Text
                  as="a"
                  color="grey2"
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text
                  ...
                  onClick={() =>
                    (window.location.href = "mailto:gabr.lima7@gmail.com")
                  }
                >
                  Enviar e-mail
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                Podemos criar conexões mais fortes compartilhando redes
                </Text>
                <Text
                  as="a"
                  color="grey2"
